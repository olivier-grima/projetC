...
void initEns(ensemble e,int n){ 
    ensemble ens[n+2]; //initialise un tableau de capacité n
}
...
void printlnEns(ensemble e){ //printlnEns (1 paramètre), écrit un ensemble e sur la sortie standard 
